                        ...
                        <div className='row'>
                            <div className='col-md-12 col-lg-6'>
                                <div style={{margin: "20px"}}>
                                    ...
                                    <h6>Trải qua hơn 15 năm hoạt động và phát triển, Coffee House đã từng bước khẳng đinh và tạo 
                                        sự tín nhiệm trong lòng khách hàng, trở thành một trong những tiệm Cà Phê chuyên nghiệp nhất cung cấp 
                                        các loại thức uống, thức ăn và nơi gặp gỡ, giải trí cho khách hàng</h6>
                                    <h6>
                                    ...
                                    <h6>Điện thoại: (024) 35737348 - Fax: (024) 35737347</h6>
                                    <h6>
