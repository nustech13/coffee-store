...
const EditProduct = ({setIsEditActive, getProducts, setLoading, product, setPage}) =>{
    ...
    const create = async (e)=>{
      ...
      if(name.length < 1){
        ...
        await axios.put('http://localhost:5000/v1/api/product/' + product._id, params)
        .then(response => {
          ...
          <div className="boxed">
            ...
            <form className="form-product" encType="multipart/form-data">
              ...
              <div className="form-input">
                ...
                <select onChange={(e)=> setCategory(e.target.value)} value={category._id}>
              ...
              <div className="form-btn-add">
                <button onClick={(e)=> create(e)}>Edit</button>
              </div>
            </form>
          </div>
        </div>
